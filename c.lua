...
local font_cash = dxCreateFont("misc/money.ttf", 18/scale_res);
...
hud.render = function()
	...
	dxDrawText(cash.."€",screen_res[1] - 520/scale_res, screen_res[2] - 1915/scale_res, 1920/scale_res, 1080/scale_res,tocolor(255,255,255),1, font_cash,"center","center",false,false,false,true,false );
